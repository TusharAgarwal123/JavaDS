...
public class KnightsTour {
	...
	/*
	 * you have a grid and position in grid,that indicate the starting position of
	 * a knights you have to print the way in which knight travel at each position 
	 * in grid.
	 */
